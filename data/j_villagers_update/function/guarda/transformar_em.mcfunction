summon mannequin ~ ~ ~ {CustomName:[{text:Guarda}],CustomNameVisible:0b,hide_description:1b,Health:40,equipment:{mainhand:{count:1,id:wooden_sword}},attributes:[{id:max_health,base:40f}],Tags:["AI_guarda","special","AI","new"],profile:{texture:"j_items:mannequin/villager_guarda"}}
